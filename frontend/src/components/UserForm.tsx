  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="h-screen w-full md:flex md:items-center md:justify-center">
        <div
          className="flex flex-col items-center justify-center px-4 h-screen gap-10
            md:w-[40%] md:border md:border-gray-300 md:h-fit md:py-10 md:px-8 md:rounded-2xl
            lg:w-[35%] xl:w-[25%]"
        >
          <p className="font-bold text-2xl">
            {isUpdating ? "Update User" : "Sing up"}
          </p>
            ...
            <div className="flex flex-col gap-7">
              ...
              <div>
                <p className="text-sm text-gray-700">
                  {isUpdating ? "New password" : "Create password"}
                </p>
