...
export default function LoginForm() {
  ...
  function validate() {
    const newErrors: { password: null | string; email: null | string } = {
      password: null,
      email: null,
    };
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="h-screen w-full md:flex md:items-center md:justify-center">
        <div
          className={`flex flex-col items-center justify-center px-4 h-screen gap-10 md:w-[40%]
            md:border md:border-gray-300 md:h-fit md:py-10 md:px-8 md:rounded-2xl xl:w-[25%] lg:w-[35%]`}
        >
